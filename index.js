...
var linkBar = document.getElementById("links");
    ...
    document.getElementById("body").style.background = "url(kyleField.jpg) no-repeat center center";
...
document.getElementById("body").style.background = "url(amFootballNight.jpg) no-repeat center center";
document.body.style.backgroundSize = "cover";
document.body.style.backgroundAttachment = "fixed";
